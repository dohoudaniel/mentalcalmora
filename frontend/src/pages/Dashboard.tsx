...
const Dashboard = () => {
  ...
  const toggleContent = () => {
    setShowQuote((prev) => {
      const next = !prev;
      if (next) setCurrentQuote(getRandomQuote());
      else setCurrentFact(getRandomFact());
      return next;
    });
  };
        ...
        <div className="container mx-auto space-y-8">
          <div className="grid gap-8 lg:grid-cols-2">
            <div className="bg-white dark:bg-slate-text p-6 rounded-lg shadow-md">
              ...
              <div className="space-y-3 text-slate-text/80 dark:text-mint-mist/80 mb-6">
                ...
                <p className="text-sm sm:text-base">Check out your personalized AI insights below</p>
              </div>
              ...
              <div className="bg-leaf-green/10 dark:bg-leaf-green/20 p-4 rounded-lg mb-4">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="flex gap-2">
                    <Button variant="ghost" size="sm" onClick={toggleContent} className="h-6 w-6 p-0 text-leaf-green hover:bg-leaf-green/20">
                      <Sparkles className="h-3 w-3" />
                    </Button>
                    <Button variant="ghost" size="sm" onClick={refreshContent} className="h-6 w-6 p-0 text-leaf-green hover:bg-leaf-green/20">
          ...
          <div className="bg-white dark:bg-slate-text p-6 sm:p-8 rounded-lg shadow-md">
            <div className="text-center mb-6">
              <h2 className="text-xl sm:text-2xl font-semibold text-slate-text dark:text-mint-mist">How are you feeling today?</h2>
            </div>
          ...
          <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
              <h2 className="text-2xl font-bold text-slate-text dark:text-mint-mist">Recent Entries</h2>
              <Link to="/history">
            ...
            {loading ? (
              <div className="text-center py-12 bg-white dark:bg-slate-text rounded-lg shadow-md">
                ...
                <p className="mt-2 text-slate-text/80 dark:text-mint-mist/80">Loading entries...</p>
              </div>
              ...
              <div className="text-center py-12 bg-white dark:bg-slate-text rounded-lg shadow-md">
                <p className="text-slate-text/80 dark:text-mint-mist/80 text-lg mb-4">No mood entries yet.</p>
                <p className="text-slate-text/60 dark:text-mint-mist/60">Add your first mood above to start tracking your emotional journey!</p>
              </div>
            )}
          </div>
