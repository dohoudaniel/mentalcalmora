      ...
      <main className="flex-grow flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-mint-mist">
        <Card className="w-full max-w-md shadow-lg bg-white">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl font-bold text-center text-slate-text">Welcome Back</CardTitle>
            <CardDescription className="text-center text-slate-text/70">Log in to your Calmora account</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link to="/forgot-password" className="text-xs text-leaf-green hover:underline">Forgot password?</Link>
                </div>
          ...
          <CardFooter className="flex flex-col space-y-4">
            <div className="text-center text-sm text-slate-text/70">
              ...
              <Link to="/signup" className="text-leaf-green hover:underline">Sign up</Link>
            </div>
          </CardFooter>
        </Card>
      </main>
