      ...
      <main className="flex-grow py-8 px-4 sm:px-6 lg:px-8 bg-mint-mist">
        <div className="container mx-auto">
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md mb-8">
            <h1 className="text-2xl font-bold text-slate-text mb-1">Mood History</h1>
            <p className="text-slate-text/80">View and analyze your previous mood entries</p>
          </div>

          <Card className="bg-white shadow-md mb-8">
            <CardHeader>
              <CardTitle className="text-xl text-slate-text">Filter Entries</CardTitle>
              <CardDescription>Find specific mood entries based on sentiment or content</CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <CardContent>
              {loading ? (
                <div className="text-center py-12">
                  ...
                  <p className="mt-2 text-slate-text/80">Loading entries...</p>
                </div>
                ...
                <div className="text-center py-12">
                  <p className="text-lg text-slate-text/80 mb-4">No entries match your current filters</p>
                  <Button
                    variant="outline"
                    onClick={() => {
                      setFilter('all');
